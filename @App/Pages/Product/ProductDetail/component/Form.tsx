...
const FormDetail = () => {
	...
	console.log('🚀 ~ file: Form.tsx:20 ~ FormDetail ~ product:', product)
	...
	return (
		<div>
			<Divider className="textTheme"> {id === 'new' ? 'Thêm sản phẩm' : ' sua san pham'}</Divider>
			...
			>
				<FileUpload formName="images" label={'Ảnh sản phẩm'} initValue={initImages} maxItem={10} form={form} />
				...
				<Row gutter={[16, 16]}>
					<Col xxl={12}>
						...
						<div className="p-4 bg-gray-100 rounded-md ">
							...
							>
								<Select placeholder="danh mục sản phẩm" allowClear options={productCategoryOptions} />
							</Form.Item>
						</div>
					</Col>
